...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ALRadioButtons/ALRadioButtons.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SKRadioButton/SKRadioButton.framework"
