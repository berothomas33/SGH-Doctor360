//
//  RadiologyRadiologyDropDown.swift
//  DoctorApp
//
...
open class RadiologyDropDown : UITextField{

    var arrow : ArrowRadio!
    ...
    public func FilterWithApi(SerchText:String)  {
        ...
        self.optionIds?.removeAll()
          ...
          API.Radiolist( Search : searchText ,completion:  { (respons, error) in
        ...
        self.ListOFDrugsloa = respons as! [labTestDoctorlist]
                          ...
                          for item in self.ListOFDrugsloa! {
                            ...
                            var dictx   = self.convertToDictionary(text:item.toJSONString()!)
                                  ...
                                  var Duar = RadiologySaved(dictionary: dictx)
...
//        arrow = ArrowRadio(origin: CGPoint(x: center.x - arrowSize/2,y: center.y - arrowSize/2),size: arrowSize  )
...
//        self.backgroundView.backgroundColor = .clear
    ...
    public func showList() {
        if parentController == nil{
            parentController = self.parentViewControllerRadio
        }
        ...
        UIView.animate(withDuration: 0.9,
                       ...
                       animations: { () -> Void in
                        ...
                        self.shadow.dropShadowRadio()
                        self.arrow.PositionRadio = .up
...
extension RadiologyDropDown : UITextFieldDelegate {
...
extension RadiologyDropDown: UITableViewDataSource {
...
extension RadiologyDropDown: UITableViewDelegate {
...
class ArrowRadio: UIView {
    ...
    var PositionRadio: PositionRadio = .down {
        didSet{
            switch PositionRadio {
            case .left:
...
extension UIView {
    ...
    func dropShadowRadio(scale: Bool = true) {
    ...
    var parentViewControllerRadio: UIViewController? {
