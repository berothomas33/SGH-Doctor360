...
open class LabDropDown : UITextField{
    ...
    public func FilterWithApi(SerchText:String)  {
        ...
        API.labListsapi( Search : searchText ,completion:  { (respons, error) in
            ...
            if(error == "" ) {
                ...
                for item in self.ListOFDrugsloa! {
                    ...
                    var Duar = LabTestSaved(dictionary: dictx)
...
//        arrow = Arrowlab(origin: CGPoint(x: center.x - arrowSize/2,y: center.y - arrowSize/2),size: arrowSize  )
...
//        self.backgroundView.backgroundColor = .clear
    ...
    public func showList() {
        if parentController == nil{
            parentController = self.parentViewControlleproce
        }
        ...
        UIView.animate(withDuration: 0.9,
                       ...
                       animations: { () -> Void in
                        ...
                        self.shadow.ProcdeureShadowlab()
                        self.arrow.Positionlab = .up
...
extension LabDropDown : UITextFieldDelegate {
...
extension LabDropDown: UITableViewDataSource {
...
extension LabDropDown: UITableViewDelegate {
...
class Arrowlab: UIView {
    ...
    var Positionlab: Positionlab = .down {
        didSet{
            switch Positionlab {
            case .left:
...
extension UIView {
    ...
    func ProcdeureShadowlab(scale: Bool = true) {
    ...
    var parentViewControlleproce: UIViewController? {
