...
open class DrugDropDown : UITextField{
    ...
    public func FilterWithApi(SerchText:String)  {
        ...
        API.DrugListsapi( Search : searchText ,completion:  { (respons, error) in
                  
                  
                  
                  if(error == "" ) {
                      
              self.ListOFDrugsloa = respons as! [DrugLists]
                    print(self.ListOFDrugsloa!.count)
                   ...
                   var Duar = DrugsSaved4(dictionary: dictx)
...
//        arrow = ArrowDR(origin: CGPoint(x: center.x - arrowSize/2,y: center.y - arrowSize/2),size: arrowSize  )
//        arrowContainerView.addSubview(arrow)
    ...
    public func showList() {
        if parentController == nil{
            parentController = self.parentViewControllerDR
        }
        ...
        UIView.animate(withDuration: 0.9,
                       ...
                       animations: { () -> Void in
                        ...
                        self.shadow.dropShadowDR()
                        self.arrow.PositionDR = .up
...
extension DrugDropDown : UITextFieldDelegate {
...
extension DrugDropDown: UITableViewDataSource {
...
extension DrugDropDown: UITableViewDelegate {
...
class ArrowDR: UIView {
    ...
    var PositionDR: PositionDR = .down {
        didSet{
            switch PositionDR {
            case .left:
...
extension UIView {
    ...
    func dropShadowDR(scale: Bool = true) {
    ...
    var parentViewControllerDR: UIViewController? {
