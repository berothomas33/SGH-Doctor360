...
struct Constants {
    ...
    static let baseUrl = "https://doctor360.sghcairo.net/api/"
    //static let blueColorCode = "8CCAE5"
    //http://41.65.118.185/api/
     static let testUrl = "https://doctor360.sghcairo.net/api/"
    
    
    
    
     static let baseUrl2 = "https://doctor360.sghcairo.net/api/"
