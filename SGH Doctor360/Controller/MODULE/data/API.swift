...
class API: NSObject {
    ...
    class func DrugListsapi (Search : String,completion :@escaping Handler) {
        ...
        APIClient.request(path: uar, method: .get, params: ["":""], headers: nil ,model: DrugLists(), completionHandler: completion)
    ...
    class func FreeqListsapi (completion :@escaping Handler) {
           ...
           APIClient.request(path: uar, method: .get, params: ["":""], headers: nil ,model: Frequncylist(), completionHandler: completion)
