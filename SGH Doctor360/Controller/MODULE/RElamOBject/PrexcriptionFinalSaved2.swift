...
@objc dynamic var FrequencyID = " "
    ...
    convenience init?(DrugName : String,DrugId : String , Remarks:Int, DurationID : String,  StrengthNo : Double , Strength :  String  ,  Duration : String , BeforeAfter : String , Frequancy :String  , Duration_No : Int  , RouteOfAdmin : String , FrequencyID : String) {
